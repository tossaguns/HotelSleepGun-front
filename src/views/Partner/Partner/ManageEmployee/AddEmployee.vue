  ...
  <TemplatePartner>
    ...
    <template #content>
      <div class="p-4 max-w-[3000px] mx-auto">
        ...
        <div
          class="flex flex-col 2xl:flex-row 2xl:justify-between 2xl:items-start mt-12"
        >
          <div
            class="2xl:w-1/3 mb-12 flex flex-col justify-center items-center"
          >
            ...
            >
              ...
              <template v-if="imagePreview">
                ...
                <button
                  class="absolute top-1 right-1 bg-white rounded-full shadow p-1 text-red-500 hover:bg-red-100"
          ...
          <div
            class="2xl:w-2/3 flex flex-col lg:flex-row lg:justify-between lg:items-start"
          >
            <div class="lg:w-1/2 px-4 space-y-3">
                ...
                <FloatInput
                  ...
                  :class="
                    highlightField === 'firstname'
                      ? 'ring-2 ring-red-400 rounded-md animate-shake'
                      : ''
                  "
                />
                <p v-if="errors.firstname" class="text-red-500 text-xs pl-2">
                  {{ errors.firstname }}
                </p>
              </div>
              ...
              <div :ref="(el) => (inputRefs.lastname = el)">
                <FloatInput
                  ...
                  "
                />
                <p v-if="errors.lastname" class="text-red-500 text-xs pl-2">
                  {{ errors.lastname }}
                </p>
              </div>
              ...
              <div :ref="(el) => (inputRefs.nickname = el)">
                <FloatInput
                  ...
                  "
                />
                <p v-if="errors.nickname" class="text-red-500 text-xs pl-2">
                  {{ errors.nickname }}
                </p>
              </div>
              ...
              <div class="" :ref="(el) => (inputRefs.sex = el)">
                <select
                  v-model="sex"
                  class="w-full py-3 border rounded-md px-3"
                  :class="
                    highlightField === 'sex'
                      ? 'ring-2 ring-red-400 rounded-md animate-shake'
                      : ''
                ...
                <p v-if="errors.sex" class="text-red-500 text-xs pl-2">
                  {{ errors.sex }}
                </p>
              </div>
            </div>
            ...
            <div class="lg:w-1/2 px-4 space-y-3 lg:mt-0 mt-3">
              <div :ref="(el) => (inputRefs.employeeCode = el)">
                <FloatInput
                  ...
                  :class="
                    highlightField === 'employeeCode'
                      ? 'ring-2 ring-red-400 rounded-md animate-shake'
                      : ''
                  "
                />
                <p v-if="errors.employeeCode" class="text-red-500 text-xs pl-2">
                  {{ errors.employeeCode }}
                </p>
              </div>
              ...
              <div :ref="(el) => (inputRefs.positionEmployee = el)">
                <FloatInput
                  v-model="positionEmployee"
                  id="positionEmployee"
                  label="ตำเเหน่ง"
                  :class="
                    highlightField === 'positionEmployee'
                      ? 'ring-2 ring-red-400 rounded-md animate-shake'
                      : ''
                  "
                />
                <p
                  v-if="errors.positionEmployee"
                  class="text-red-500 text-xs pl-2"
                >
                  {{ errors.positionEmployee }}
                </p>
              </div>
              ...
              <div :ref="(el) => (inputRefs.email = el)">
                <FloatInput
                  ...
                  "
                />
                <p v-if="errors.email" class="text-red-500 text-xs pl-2">
                  {{ errors.email }}
                </p>
              </div>
              ...
              <div :ref="(el) => (inputRefs.phone = el)">
                <FloatInput
                  ...
                  "
                />
                <p v-if="errors.phone" class="text-red-500 text-xs pl-2">
                  {{ errors.phone }}
                </p>
              </div>
            </div>
        ...
        <div class="max-w-xl mx-auto mt-12 space-y-3 px-4">
          <div :ref="(el) => (inputRefs.statusByPartner = el)">
            <div class="flex space-x-1 my-1">
              <p class="pl-3">สำคัญ</p>
              <!--sex-->
              <p class="text-red-600">*</p>
            </div>
            <select
              v-model="statusByPartner"
              class="w-full border rounded-md p-3"
              :class="
                highlightField === 'statusByPartner'
                  ? 'ring-2 ring-red-400 rounded-md animate-shake'
                  : ''
              "
            >
            ...
            <p v-if="errors.statusByPartner" class="text-red-500 text-xs pl-2">
              {{ errors.statusByPartner }}
            </p>

            <div v-if="statusByPartner === 'cleaner'" class="mt-3">
              <label class="block font-semibold mb-2">
                เลือกห้องที่รับผิดชอบ (เลือกได้หลายห้อง)
              </label>
              <select
                v-model="rooms"
                multiple
          ...
          <div :ref="(el) => (inputRefs.username = el)">
            <FloatInput
              ...
              "
            />
            <p v-if="errors.username" class="text-red-500 text-xs pl-2">
              {{ errors.username }}
            </p>
          </div>
          ...
          <div :ref="(el) => (inputRefs.password = el)">
            <FloatInput
              ...
              "
            />
            <p v-if="errors.password" class="text-red-500 text-xs pl-2">
              {{ errors.password }}
            </p>
          </div>
        </div>
...
function scrollToFirstErrorWithAnimation() {
  const firstErrorKey = Object.keys(errors.value).find(
...
watch(statusByPartner, (val) => {
  if (val) errors.value.statusByPartner = "";
});
watch(username, (val) => {
  if (val.trim()) errors.value.username = "";
});
watch(password, (val) => {
  if (val.trim()) errors.value.password = "";
});
...
async function confirmSave() {
  ...
  try {
    ...
    const res = await fetch(
      "http://localhost:9999/HotelSleepGun/employee/create",
      {
        method: "POST",
        body: formData,
        headers: {
